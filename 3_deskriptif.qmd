...
**Bab 8. Ukuran Penyebaran Data:**

-   Menjelaskan konsep dispersi sebagai ukuran penyebaran data serta membedakan berbagai ukuran dispersi.
-   Menghitung dan menginterpretasikan ukuran penyebaran data untuk menilai tingkat keragaman data serta membandingkan penyebaran antar kelompok data dalam konteks penelitian psikologi dan ilmu sosial.

**Bab 9. Bentuk Distribusi Data:**

-   Menjelaskan karakteristik bentuk distribusi data serta menginterpretasikan implikasinya terhadap analisis statistik.
-   Menghitung dan menginterpretasikan z-score untuk menentukan posisi relatif suatu nilai dalam distribusi data dan mengidentifikasi nilai ekstrem (*outlier*).
:::
