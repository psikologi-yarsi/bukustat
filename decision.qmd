...
<head>
  ...
  <title>Decision Tree Statistik — S1 (v2.9)</title>
  <style>
...
<body>
  <div class="wrap">
    <h1>Decision Tree Analisis Statistik (S1)</h1>
    ...
    <p class="muted" style="font-size:12px;margin-top:12px">Catatan: alat bantu edukatif; tetap perhatikan rancangan studi, kualitas data, dan pemenuhan asumsi sebelum menarik kesimpulan.</p>
  </div>
  ...
  const NODES = {
    ...
    Q_PREDICTOR_TYPE_MULTI: { id:'Q_PREDICTOR_TYPE_MULTI', kind:'question', title:'Komposisi variabel?', options:[
      {label:'Semua kontinyu', next:'M_LM'},
      {label:'Semua kategorikal', next:'Q_PREDICTOR_TYPE_MULTI_CAT'},
      {label:'Campuran (kontinyu + kategorikal)', next:'MR_ANC'},
    ]},
    Q_PREDICTOR_TYPE_MULTI_CAT: { id:'Q_PREDICTOR_TYPE_MULTI_CAT', kind:'question', title:'Jika variabel bebas kategorikal: komposisi sampel?', options:[
      {label:'Sampel independen', next:'F_ANOVA'},
      {label:'Sampel berpasangan', next:'FR_ANOVA'},
      {label:'Campuran', next:'FM_ANOVA'},
    ]},
    ...
    R_PEARSON: { id:'R_PEARSON', kind:'result', title:'Korelasi Pearson r/Simple Linear Regression' },
    ...
    M_LM: { id:'M_LM', kind:'result', title:'Multiple Linear Regression' },
    F_ANOVA: { id:'F_ANOVA', kind:'result', title:'Independent Factorial ANOVA' },
    FR_ANOVA: { id:'FR_ANOVA', kind:'result', title:'Factorial Repeated Measures ANOVA' },
    FM_ANOVA: { id:'FM_ANOVA', kind:'result', title:'Factorial Mixed ANOVA' },
    MR_ANC: { id:'MR_ANC', kind:'result', title:'Multiple Regression/ANCOVA' },
